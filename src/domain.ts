...
export type BrowserState = { task: string; page: { url: string; title: string; origin: string }; interactiveElements: InteractiveElement[]; visibleText: string; observationId: string; observedAt: string; recentActions?: Array<{ kind: string; locator?: string; inputKey?: string; status: string }>; workflow?: { kind: string; target?: string; inputKeys?: string[]; allowedActions: string[]; finalImpact?: boolean } };
